...
public class ReminderApiClient(HttpClient httpClient) : ApiClient(httpClient)
{
    ...
    {
        return await SendAsync<ReminderDto>(HttpMethod.Patch, $"/api/reminders/{Id}/update-fire-at", null, cancellationToken);
    }
    ...
    {
        return await SendAsync<ReminderDto>(HttpMethod.Patch, $"/api/reminders/{Id}/snooze", reuqest, cancellationToken);
    }
