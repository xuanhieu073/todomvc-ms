...
export class TodoFooterComponent {
  ...
  readonly filter$ = toSignal(this.todosStore.filter$);
  readonly completedCount$ = toSignal(this.todosStore.completedCount$, { initialValue: 0 });
  readonly inCompletedCount$ = toSignal(this.todosStore.inCompletedCount$, { initialValue: 0 });
